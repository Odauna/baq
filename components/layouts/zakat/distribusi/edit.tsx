...
import { upDistribusi } from "@/lib/zakat/distribusi"
...
export function DialogEditDistribusi({
    d_id,
    d_nama,
    d_alamat,
    d_keterangan,
    ...
    const boundUpDistribusi = upDistribusi.bind(null, d_id)
    const {executeAsync, result} = useAction(boundUpDistribusi)
    ...
    return (
        <DialogContent>
            <DialogHeader>
                <DialogTitle>Formulir Ubah Data Distribusi</DialogTitle>
