...
import { addNominalTimbangan } from "@/lib/zakat/pengumpulan"
...
export function DialogAddTimbang() {
    ...
    const {executeAsync, result} = useAction(addNominalTimbangan)
    ...
    return (
        <DialogContent>
            <DialogHeader>
                <DialogTitle>Formulir Tambah Nominal Timbangan Pengumpulan Zakat Beras</DialogTitle>
