...
function Meja() {
    const {data, error, isLoading} = useSWR(`${Host}/api/zakat/dashboard/zi-rt?rt=01&rtl=06`, fetcher)
    ...
    return (
        <>
        <CardHeader className="items-center pb-0">
            <CardTitle>Meja 02 (RT.01 & RT.06)</CardTitle>
...
export function RCSZIMeja2() {
    return (
        <Card className="flex flex-col max-h-[250px] w-[680px] gap-1 mt-2 pt-3">
            <Meja />
        </Card>
    )
}