...
function Meja() {
    const {data, error, isLoading} = useSWR(`${Host}/api/zakat/dashboard/zi-rt?rt=02&rtl=05`, fetcher)
    ...
    return (
        <>
        <CardHeader className="items-center pb-0">
            <CardTitle>Meja 03 (RT.02 & RT.05)</CardTitle>
...
export function RCSZIMeja3() {
    return (
        <Card className="flex flex-col max-h-[250px] w-[680px] gap-1 py-3">
            <Meja />
        </Card>
    )
}